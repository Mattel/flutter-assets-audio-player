...
class NotificationService : Service() {
    ...
    private fun displayNotification(action: NotificationAction.Show, bitmap: Bitmap?) {
        ...
        val pendingToggleIntent = PendingIntent.getBroadcast(this, 0, toggleIntent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)
                ...
                .apply {
                    if (notificationSettings.prevEnabled) {
                        addAction(getPrevIcon(context, action.notificationSettings.previousIcon), "prev",
                                PendingIntent.getBroadcast(context, 0, createReturnIntent(forAction = NotificationAction.ACTION_PREV, forPlayer = action.playerId, audioMetas = action.audioMetas),
